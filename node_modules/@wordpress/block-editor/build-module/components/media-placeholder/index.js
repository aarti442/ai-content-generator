  ...
  const defaultRenderPlaceholder = content => {
    ...
    if (instructions === undefined || title === undefined) {
      ...
      if (instructions === undefined && mediaUpload) {
        instructions = __('Drag and drop an image or video, upload, or choose from your library.');
        if (isAudio) {
          instructions = __('Drag and drop an audio file, upload, or choose from your library.');
        } else if (isImage) {
          instructions = __('Drag and drop an image, upload, or choose from your library.');
        } else if (isVideo) {
