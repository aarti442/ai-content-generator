...
export function DimensionsPanel({
  ...
  const defaultDimensionsControls = getBlockSupport(name, [DIMENSIONS_SUPPORT_KEY, 'defaultControls']);
  const defaultSpacingControls = getBlockSupport(name, [SPACING_SUPPORT_KEY, 'defaultControls']);
