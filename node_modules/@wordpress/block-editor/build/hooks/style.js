...
const skipSerializationPathsEdit = {
  [`${_border.BORDER_SUPPORT_KEY}.skipSerialization`]: ['border'],
  [`${_color.COLOR_SUPPORT_KEY}.skipSerialization`]: [_color.COLOR_SUPPORT_KEY],
  [`${_typography.TYPOGRAPHY_SUPPORT_KEY}.skipSerialization`]: [_typography.TYPOGRAPHY_SUPPORT_KEY],
  [`${_dimensions.DIMENSIONS_SUPPORT_KEY}.skipSerialization`]: [_dimensions.DIMENSIONS_SUPPORT_KEY],
  [`${_dimensions.SPACING_SUPPORT_KEY}.skipSerialization`]: [_dimensions.SPACING_SUPPORT_KEY],
  [`${_border.SHADOW_SUPPORT_KEY}.skipSerialization`]: [_border.SHADOW_SUPPORT_KEY]
};
