...
const getAllowedBlocks = exports.getAllowedBlocks = (0, _data.createRegistrySelector)(select => (0, _data.createSelector)((state, rootClientId = null) => {
  ...
  return blockTypes;
}, (state, rootClientId) => [(0, _blocks.getBlockTypes)(), (0, _lockUnlock.unlock)(select(_constants.STORE_NAME)).getReusableBlocks(), ...(0, _utils.getInsertBlockTypeDependants)(select)(state, rootClientId)]));
