  ...
  for (const variation of variations) {
    if (Array.isArray(variation.isActive)) {
      ...
      const isMatch = definedAttributes.every(attribute => {
        const variationAttributeValue = (0, _utils.getValueFromObjectPath)(variation.attributes, attribute);
        if (variationAttributeValue === undefined) {
          return false;
        }
        let blockAttributeValue = (0, _utils.getValueFromObjectPath)(attributes, attribute);
        if (blockAttributeValue instanceof _richText.RichTextData) {
          blockAttributeValue = blockAttributeValue.toHTMLString();
        }
        return (0, _utils.matchesAttributes)(blockAttributeValue, variationAttributeValue);
      });
...
const __experimentalHasContentRoleAttribute = (...args) => {
  (0, _deprecated.default)('__experimentalHasContentRoleAttribute', {
    since: '6.7',
    version: '6.8',
    hint: 'This is a private selector.'
  });
  return (0, _privateSelectors.hasContentRoleAttribute)(...args);
};
