...
export type SlotComponentProps = (SlotPropBase & {
    /**
...
export type BaseSlotFillContext = {
    ...
    getFills: (name: SlotKey, slotInstance: Rerenderable) => FillComponentProps[];
